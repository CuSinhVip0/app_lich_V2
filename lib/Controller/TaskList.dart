...
class TaskListController extends GetxController{
	...
	void addTaskNoCallApi (Map<String, dynamic> element){
		var listTaskInHour =  taskLists.firstWhereOrNull((e) => e[0] == element['GioBatDau']);
		(listTaskInHour!=null) ? listTaskInHour[1].add(element)
		 : taskLists.add([ element['GioBatDau'] == "00:00" && element['GioKetThuc'] == "24:00" ? "Cả ngày": element['GioBatDau'],[element]]);
		taskLists.refresh();
	}
