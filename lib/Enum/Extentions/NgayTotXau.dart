...
class NgayTotXau{
	static List<Item> item =[
		new Item('Ngày đính hôn', Iconify(EmojioneV1.man_and_woman_holding_hands,size: 28,),{
			'title': 'Ngày đính hôn',
		...
		new Item('Lễ ăn hỏi', Iconify(EmojioneV1.ring,size: 28),{
			'title': 'Lễ ăn hỏi',
		...
		new Item('Ngày thành hôn', Iconify(EmojioneV1.revolving_hearts,size: 28),{
		...
		new Item('Dỡ nhà phá tường', Iconify(EmojioneV1.wrench,size: 28),{
			'title': 'Ngày dỡ nhà phá tường',
			"key": 36
		}),
		new Item('Phá dỡ nhà', Iconify(EmojioneV1.hammer_and_wrench,size: 28),{
			'title': 'Ngày phá dỡ nhà',
		...
		new Item('Sửa chữa nhà kho', Iconify(EmojioneV1.i_factory,size: 28),{
			'title': 'Ngày sửa chữa nhà kho',
		...
		new Item('Tu taọ sửa chữa', Iconify(EmojioneV1.scissors,size: 28),{
			'title': 'Ngày tu taọ sửa chữa',
			"key":10
		}),
		new Item('Đào giếng', Iconify(EmojioneV1.bomb,size: 28),{
			'title': 'Ngày đào giếng',
		...
		new Item('Khai trương', Iconify(EmojioneV1.office_building,size: 28),{
		...
		new Item('Kí kết hợp đồng', Iconify(EmojioneV1.memo,size: 28),{
			'title': 'Ngày kí kết hợp đồng',
		...
		new Item('Xuất hàng hóa', Iconify(EmojioneV1.card_file_box,size: 28),{
			'title': 'Ngày xuất hàng hóa',
		...
		new Item('Xuất hành', Iconify(EmojioneV1.airplane_arrival,size: 28),{
			'title': 'Ngày xuất hành',
		...
		new Item('Cầu phúc', Iconify(EmojioneV1.family_man_woman_girl_boy,size: 28),{
			'title': 'Ngày cầu phúc',
		...
		new Item('Cầu cúng', Iconify(EmojioneV1.carp_streamer,size: 28),{
			'title': 'Ngày cầu cúng',
		...
		new Item('Cầu tự', Iconify(EmojioneV1.baby_angel,size: 28),{
			'title': 'Ngày cầu tự',
		...
		new Item('Nhập học', Iconify(EmojioneV1.school,size: 28),{
			'title': 'Ngày nhập học',
			"key":12
		}),
		new Item('Nhận phong tước vị', Iconify(EmojioneV1.trophy,size: 28),{
			'title': 'Ngày nhận phong tước vị',
			"key":23
		}),
		new Item('Mua gia súc', Iconify(EmojioneV1.pig,size: 28),{
			'title': 'Ngày mua gia súc',
			"key":38
		}),
